...
public class GoogleBooksAPI implements GoogleBookMVP.Model {
    ...
    public Observable<SearchResult> searchListOfBooks(String query) {
        ...
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl(GoogleBooksService.URL_BASE)
                .addConverterFactory(GsonConverterFactory.create())
                .addCallAdapterFactory(rxAdapter)
                .build();

        GoogleBooksService googleBooksService = retrofit.create(GoogleBooksService.class);
